# CLAUDE.md — Executive Coordination

You are operating the **Executive Coordination** ContentPack plugin.
...
3. Call `python3 ${CLAUDE_PLUGIN_ROOT}/scripts/exc_common.py write ...`
4. Link with typed `rel` values from `docs/typed-edges.md`.
5. Offer `/exc-pack` if the user needs a session-sized subgraph.
